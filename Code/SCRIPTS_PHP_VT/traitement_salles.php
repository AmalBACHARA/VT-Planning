...
$requete = "SELECT 	* FROM ressources_salles WHERE ressources_salles.nom = '$nom ';";
$resultat = mysql_query($requete);
$mess="";
if($resultat) { // requete OK
    $user = mysql_fetch_assoc($resultat);
	if  ($user=='') {$mess = vers_page("Désolé, cette salle n'est pas présente dans la base");}
	}
else { // requete pas OK
...
WHERE 	ressources_salles.nom = '$nom' 
...
<TITLE>EMPLOI DU TEMPS SALLE</TITLE>
...
Emploi du temps de la salle: <? echo $prenom; echo " "; echo $nom;?>
</FONT>
	...
	<tbody>
		<tr>
			<td align="center" nowrap="nowrap" valign="bottom">
				<? 
					$dateTemp = date("U");
					echo "<a href=\"traitement_salles.php?date=$dateTemp\">"; 
				?>
				<img src="media/today.gif" border="0" alt="Aujourd'hui" title="Aujourd'hui"/><br/>Semaine courante</a> 
			</td>
			<td width="100%" align="center">
				<? echo "<a href=\"traitement_salles.php?date=$lundiAvantSecondes\">"; ?>
				...
				<? echo "<a href=\"traitement_salles.php?date=$lundiApresSecondes\">"; ?>
                <img src="media/next.gif" border="0" alt="Semaine suivante" title="Semaine suivante" hspace="2" />
                </a>
            </td>
			<td align="center" nowrap="nowrap" valign="middle">
				<a href="./index_salle.html">Changer de salle</a> 
			</td>			
		</tr>
	</tbody>
</table>
